...
export declare class ColliderDesc {
    ...
    static convexDecomposition(vertices: Float32Array, indices: Uint32Array): ColliderDesc;
    static compound(shapes: Array<Shape>, positions: [number, number][]): ColliderDesc;
    /**
