...
export class RawShape {
    ...
    * @returns {RawShape}
    */
    static compound(shape_types, sizes, offsets) {
        const ptr0 = passArrayJsValueToWasm0(shape_types, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(sizes, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayF32ToWasm0(offsets, wasm.__wbindgen_malloc);
